...
import com.umatthieu.timerpractice.AppConstants
import com.umatthieu.timerpractice.R
import com.umatthieu.timerpractice.TimerActivity
import com.umatthieu.timerpractice.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            nBuilder.setContentTitle("Timer is Running")
                    .setContentText("Ends: ${df.format(Date(wakeUpTime))}")
                    .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                    .setOngoing(true)
